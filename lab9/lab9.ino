...
// 題目：訓練一個能分辨三個類別的模型，並把辨識結果顯示在 LCD 上面
...
//輸入WIFI連線帳號密碼
const char* ssid     = "bazookam1a1";   //your network SSID
const char* password = "29396527";   //your network password
...
#include <Wire.h> 
#define I2C_SDA 3 // 要避開被占用的腳位
#define I2C_SCL 46 // 要避開被占用的腳位
